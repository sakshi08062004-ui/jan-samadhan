...
function updateUIForAuthenticatedUser(user) {
    ...
    const userNavItems = ['complaints', 'dashboard', 'profile', 'notifications', 'reports', 'leaderboard'];
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">${user.level} ${user.badge}</small>
                            </div>
                        </div>
                        <div class="text-end">
                            <div class="fs-5 fw-bold">${user.points}</div>
...
async function submitComplaint() {
    ...
    try {
        ...
        if (response.ok) {
            showNotification(`Complaint submitted successfully! You earned ${data.points_awarded} points!`, 'success');
